...
#
# Generated by export_simulation on Wed Jan 31 21:20:45 +0900 2018
#
################################################################################
...
'-reset_run' switch to the './c_counter_binary_16bits.sh' script.

./c_counter_binary_16bits.sh -reset_run
...
./c_counter_binary_16bits.sh -noclean_files

For more information on the script, please type './c_counter_binary_16bits.sh -help'.
