...
#
# Generated by Vivado on Sun Jan 07 21:10:34 +0900 2018
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_0 $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2017.3/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"E:/Xilinx/Vivado/2017.3/data/xilinx_vip/include" \
    "$ref_dir/../../../../v1_02.srcs/sources_1/ip/blk_mem_gen_0/sim/blk_mem_gen_0.v" \
  2>&1 | tee -a vlogan.log
