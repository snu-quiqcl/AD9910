...
set_property -dict {PACKAGE_PIN M17 IOSTANDARD LVCMOS33} [get_ports ja_5]
...
set_property DRIVE 16 [get_ports jb_1]
set_property SLEW FAST [get_ports jb_1]
set_property DRIVE 16 [get_ports jb_3]
set_property SLEW FAST [get_ports jb_3]
set_property SLEW FAST [get_ports jb_5]
set_property DRIVE 16 [get_ports jb_5]
set_property DRIVE 16 [get_ports jb_7]
set_property SLEW FAST [get_ports jb_7]


set_property SLEW FAST [get_ports ja_0]
set_property SLEW FAST [get_ports ja_1]
set_property DRIVE 16 [get_ports ja_0]
set_property DRIVE 16 [get_ports ja_1]
set_property DRIVE 16 [get_ports ja_4]
set_property SLEW FAST [get_ports ja_4]
set_property DRIVE 16 [get_ports ja_5]
set_property DRIVE 16 [get_ports ja_6]
set_property SLEW FAST [get_ports ja_5]
