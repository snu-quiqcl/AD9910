...
// 
// Revision:
// Revision 0.01 - Added warning for the case when all the trigger masks are set to zero
// Additional Comments:
// 
//////////////////////////////////////////////////////////////////////////////////
...
(
    ...
    // The above logic has a risk that when all the mask are 0, it will trigger immediately, so if it is a problem, I need to handle that case separately.
