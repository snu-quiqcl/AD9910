...
HD_PWD='O:/Users/thkim/Arty_S7/Sequencer/v3_05/v3_05.runs/c_counter_binary_16bits_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log c_counter_binary_16bits.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source c_counter_binary_16bits.tcl
