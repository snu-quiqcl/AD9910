...
HD_PWD='O:/Users/thkim/Arty_S7/Sequencer/v3_03/v3_03.runs/fifo_generator_bram_64x1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_generator_bram_64x1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_generator_bram_64x1024.tcl
