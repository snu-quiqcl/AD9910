...
HD_PWD='O:/Users/thkim/Arty_S7/Sequencer/v3_05/v3_05.runs/clk_800MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_800MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_800MHz.tcl
