...
Initialize_time_start = 100          #100ns
Initialize_time_step = 100           #100ns
Initialize_time_stop = 3000          #3 us
...
def Code_program(Initialize_time):
...
if __name__ == '__main__':
    ...
    raw_data = []
    values = []
    Initialize_time = Initialize_time_start
    while(Initialize_time < Initialize_time_stop):
        s = Code_program(Initialize_time)
#        print('coding done')
...
#        print('execution done')
        ...
        values.append([Initialize_time, stat.mean(temp), stat.stdev(temp)])
        
        Initialize_time += Initialize_time_step
