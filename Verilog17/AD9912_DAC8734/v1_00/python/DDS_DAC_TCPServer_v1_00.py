...
# 1.01: changed to power_table_v2_00. 
# TO-DO list
...
from power_table_v1_00 import power_table
...
if __name__ == "__main__":
    ...
    #DDS1_pt = power_table(dirname+'\calibration_DDS1_DAC1_HSTL_FB_connected_DDS_full_current_ZX73-2500-S+_180215.csv', -60, -3.5)
    #DDS2_pt = power_table(dirname+'\calibration_DDS2_DAC0_DDS_full_current_ZX73-2500-S+_180215.csv', -60, 1.0)
    DDS2_pt = power_table('calibration_DDS2_DAC0_HSTL_FB_connected_DDS_full_current_ZX73-2500-S+_180215.csv', -60, -3.5)
    DDS1_pt = power_table('calibration_DDS1_DAC1_DDS_full_current_ZX73-2500-S+_180215.csv', -60, 1.0)
