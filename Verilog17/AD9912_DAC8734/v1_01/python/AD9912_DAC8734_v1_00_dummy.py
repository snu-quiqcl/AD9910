...
class FPGA(ArtyS7):
    def __init__(self, serialPort):
        print('Serial port %s open is called' % serialPort)
        
    def close(self):
        print('FPGA close called')
...
class DAC8734():
    ...
    def update_ldac_period(self, clock_count):
        print('update_ldac_period called')
        return
        if clock_count > 255:
...
class AD9912():
    ...
    def set_frequency(self, freq_in_MHz, ch1, ch2):
        ...
        print('set_frequency(%f, %d, %d) is called' % (freq_in_MHz, ch1, ch2))
        return
        ...
        self.fpga.send_mod_BTF_int_list(self.make_9int_list('000501', 1, 1)) # Update the buffered (mirrored) registers
        self.fpga.send_command('WRITE DDS REG')
    ...
    def set_current(self, current, ch1, ch2):
        ...
        print('set_current(%f, %d, %d) is called' % (current, ch1, ch2))    
        return
    ...
    def ch2_trigger_output(self, on=True):
        ...
        print('ch1_trigger_output(%s) is called' % str(on))
        return
        self.fpga.send_mod_BTF_int_list( \
    ...
    def soft_reset(self, ch1, ch2):
        print('soft_reset(%d, %d) is called' % (ch1, ch2))
        return
    ...
    def set_phase(self, phase, ch1, ch2):
        print('set_phase(%d, %d, %d) is called' % (phase, ch1, ch2))
        return
    ...
    def power_down(self, ch1, ch2):
        print('power_down(%d, %d) is called' % (ch1, ch2))
        return
        # Digital powerdown
    ...
    def power_up(self, ch1, ch2):
        print('power_up(%d, %d) is called' % (ch1, ch2))
        return
